...
fn scene_feature_importance_3d(save: bool) {
    ...
    let sizes: Vec<f32> = importances
        .iter()
        .map(|v| 4.0 + (*v as f32) * 20.0)
        .collect();
...
fn iris_dataset() -> Dataset {
    ...
    let petal_length = vec![
        1.4, 1.4, 1.3, 1.5, 1.4, 1.7, 1.4, 1.5, 1.4, 1.5, 1.5, 1.6, 1.4, 1.1, 1.2, 1.5, 1.3, 1.5,
        ...
        4.8, 4.9, 5.6, 5.8, 6.1, 6.4, 5.6, 5.1, 5.6, 6.1, 5.6, 5.5, 4.8, 5.4, 5.6, 5.1, 5.9, 5.7,
        5.2, 5.0, 5.2, 5.4, 5.1, 5.1,
    ];
    let petal_width = vec![
        ...
        1.8, 2.5, 2.0, 1.9, 2.1, 2.0, 2.4, 1.8, 1.8, 2.1, 2.4, 2.3, 1.5, 2.3, 2.0, 2.0, 1.8, 2.1,
