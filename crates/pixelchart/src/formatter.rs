...
///
/// ```
/// use pixelchart::formatter::LocaleConfig;
///
...
///
/// ```
/// use pixelchart::formatter::{BinarySiFormatter, TickFormatter};
///
...
///
/// ```
/// use pixelchart::formatter::{EngineeringFormatter, TickFormatter};
///
...
///
/// ```
/// use pixelchart::formatter::FnFormatter;
///
...
///
/// ```
/// use pixelchart::formatter::{ThousandsFormatter, TickFormatter};
///
...
///
/// ```
/// use pixelchart::formatter::DateTimeFormatter;
///
...
///
/// ```
/// use pixelchart::formatter::{LocaleFormatter, LocaleConfig, FixedDecimalFormatter, TickFormatter};
///
