//! Visual Demo — a beautiful 6-panel dashboard showcasing pixelchart's capabilities.
//!
...
//!
//! ```bash
//! cargo run -p pixelchart --example visual_demo
//! ```
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    loop {
        terminal.draw(|frame| {
            ...
            // Status bar
            let status =
                Paragraph::new(" pixelchart visual demo  │  6 chart types  │  q/Esc to quit")
