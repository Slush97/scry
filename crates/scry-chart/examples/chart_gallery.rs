...
fn main() {
    ...
    let charts: Vec<(&str, Chart)> = vec![
        // ---- Core chart types ----
        ("01_line", Chart::line(&[10.0, 25.0, 18.0, 35.0, 28.0, 42.0, 38.0, 50.0])
            .title("Line Chart")
        ...
        ("02_area", Chart::area(&[3.0, 7.0, 4.0, 9.0, 6.0, 8.0, 5.0, 11.0])
            .title("Area Chart")
            .x_label("Time").y_label("Value")
            .theme(Theme::dark()).build()),

        ("03_scatter", Chart::scatter(
        ...
        ("18_sparkline", Chart::sparkline(&[3.0, 7.0, 4.0, 9.0, 6.0, 8.0, 5.0, 11.0, 7.0, 13.0])
            .build()),

        // ---- Theme comparison (line chart across all themes) ----
        ("19_theme_light", Chart::line(&[10.0, 25.0, 18.0, 35.0, 28.0, 42.0])
            .title("Light Theme").x_label("X").y_label("Y")
            .theme(Theme::light()).build()),
        ("20_theme_pastel", Chart::line(&[10.0, 25.0, 18.0, 35.0, 28.0, 42.0])
            .title("Pastel Theme").x_label("X").y_label("Y")
            .theme(Theme::pastel()).build()),
        ("21_theme_ocean", Chart::line(&[10.0, 25.0, 18.0, 35.0, 28.0, 42.0])
            .title("Ocean Theme").x_label("X").y_label("Y")
            .theme(Theme::ocean()).build()),
        ("22_theme_forest", Chart::line(&[10.0, 25.0, 18.0, 35.0, 28.0, 42.0])
            .title("Forest Theme").x_label("X").y_label("Y")
            .theme(Theme::forest()).build()),
        ("23_theme_colorblind", Chart::line(&[10.0, 25.0, 18.0, 35.0, 28.0, 42.0])
            .title("Colorblind Theme").x_label("X").y_label("Y")
            .theme(Theme::colorblind()).build()),

        // ---- Stress tests ----
        ("24_bar_many_categories", Chart::bar(
        ...
        ("25_histogram_dense", {
            ...
            Chart::histogram(&data).bins(40)
                .title("Dense Histogram (2000 pts, 40 bins)")
                .theme(Theme::dark()).build()
        }),

        ("26_bar_horizontal", Chart::bar(
