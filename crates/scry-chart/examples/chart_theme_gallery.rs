...
fn main() -> Result<(), String> {
    ...
    for (theme_name, theme) in &themes {
        ...
        emit(
            ...
            Charts::violin(vec![
                ...
                (
                    "Group C",
                    (0..80)
                        .map(|i| 12.0 + (i as f64 * 0.3).sin() * 3.0 + i as f64 * 0.05)
                        .collect(),
                ),
            ])
            .title("Violin Plot")
        ...
        let many_values: Vec<f64> = (0..20)
            .map(|i| 10.0 + (i as f64 * 0.7).sin() * 5.0)
            .collect();
        emit(
            "Many Labels (20)",
    ...
    // =============================================================
    {
        ...
        femit(
            ...
            Charts::line(&[10.0, 25.0, 18.0, 35.0, 28.0, 42.0, 30.0])
                ...
                .h_line_styled(
                    20.0,
                    scry_engine::style::Color::from_rgba8(255, 100, 100, 180),
                )
                .v_line(3.0)
                .theme(theme.clone())
                .build(),
        ...
        femit(
            ...
            LineChart::new(vec![
                Series::new(
                    "Temperature (°C)",
                    vec![22.0, 24.0, 28.0, 26.0, 23.0, 25.0, 27.0],
                ),
                Series::new(
                    "Humidity (%)",
                    vec![60.0, 55.0, 45.0, 50.0, 65.0, 58.0, 48.0],
                ),
            ])
        ...
        femit(
            ...
            Charts::bar(
                ...
                &(0..15)
                    .map(|i| 10.0 + (i as f64 * 0.7).sin() * 8.0)
                    .collect::<Vec<_>>(),
            )
...
"#,
    ...
    for (ti, tn) in theme_names.iter().enumerate() {
        ...
        html.push_str(&format!(
            "<div class=\"theme-section\" data-theme=\"{tn}\">\n"
        ));
        html.push_str(&format!(
            "<h2>Theme: {}</h2>\n<div class=\"grid\">\n",
            capitalize(tn)
