//! Feature showcase — demonstrates every new feature added to scry-chart.
//!
...
//! - Time scale
//!
//! Usage: cargo run -p scry-chart --example feature_showcase

use scry_chart::data::Series;
use scry_chart::export;
use scry_chart::prelude::*;
use scry_chart::svg_export;
use scry_chart::theme::Theme;
use scry_chart::time_scale::TimeScale;
...
fn main() {
    ...
    println!("╔══════════════════════════════════════════╗");
    println!("║      scry-chart Feature Showcase         ║");
    println!("╚══════════════════════════════════════════╝\n");
