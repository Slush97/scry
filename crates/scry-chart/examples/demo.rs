...
//! Press 'q' to quit.
//!
//! Run with: `cargo run -p scry-chart --example demo`
...
fn build_line_area_fill() -> Chart {
    ...
    Chart::line(&revenue)
        ...
        .h_line_styled(
            8.0,
            scry_engine::style::Color::from_rgba8(252, 129, 155, 180),
        )
        .y_range(0.0, 16.0)
        .theme(Theme::dark())
        .build()
...
fn build_histogram_density() -> Chart {
    ...
    Chart::histogram(&data)
        ...
        .v_line_styled(
            mean,
            scry_engine::style::Color::from_rgba8(255, 90, 90, 220),
        )
        .v_line_styled(
            -1.0,
            scry_engine::style::Color::from_rgba8(130, 130, 200, 150),
        )
        .v_line_styled(
            1.0,
            scry_engine::style::Color::from_rgba8(130, 130, 200, 150),
...
fn build_heatmap_custom() -> Chart {
    ...
    Chart::heatmap(data)
        ...
        .col_labels(cols)
        .colors(
            scry_engine::style::Color::from_rgba8(20, 30, 60, 255),
            scry_engine::style::Color::from_rgba8(80, 255, 120, 255),
        )
        .range(0.0, 55.0)
        .values(false)
        .cell_radius(2.0)
