...
//!
//! Exercises every public API surface of both `scry-engine` and
//! `scry-chart` in a single animated dashboard.
//!
//! Run with: `cargo run -p scry-chart --example powertest_v2`
