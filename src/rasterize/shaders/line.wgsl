// Anti-aliased line segment shader for 2D rasterization.
//
// Each line segment is expanded into a screen-aligned quad with the
// specified width + 1px for anti-aliasing. Handles Line and Polyline
// commands (decomposed into individual segments on the CPU side).
//
// Adapted from the 3D line.wgsl shader in scry-chart.
...
struct VertexInput {
    ...
    @location(4) edge_dist: f32,       // signed distance from line center (-1 or +1)
};
