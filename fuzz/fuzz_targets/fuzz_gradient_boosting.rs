//! Fuzz target: Gradient Boosting classifier + regressor.
//!
//! Exercises GradientBoostingClassifier and GradientBoostingRegressor with
//! small ensembles on fuzz-derived datasets.

#![no_main]

use libfuzzer_sys::fuzz_target;
use scry_learn::dataset::Dataset;
use scry_learn::tree::{GradientBoostingClassifier, GradientBoostingRegressor};
