//! Fuzz target: Random Forest classifier + regressor.
//!
//! Exercises RandomForestClassifier and RandomForestRegressor with small
//! ensembles on fuzz-derived datasets.

#![no_main]

use libfuzzer_sys::fuzz_target;
use scry_learn::dataset::Dataset;
use scry_learn::tree::{RandomForestClassifier, RandomForestRegressor};
